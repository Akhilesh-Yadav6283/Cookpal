...
document
  ...
  .addEventListener("click", () => filteredRecipesfn());
document
  .getElementById("showveg")
  .addEventListener("click", () => filteredRecipesfn("veg"));
document
  .getElementById("shownonveg")
  .addEventListener("click", () => filteredRecipesfn("non-veg"));
